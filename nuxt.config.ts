...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    googleOAuthRedirectUrl: process.env.NUXT_GOOGLE_OAUTH_REDIRECT_URL || '',
    googleOAuthHostedDomain: process.env.NUXT_GOOGLE_OAUTH_HOSTED_DOMAIN || 'student.clhs.tyc.edu.tw',
    turnstileSecretKey: process.env.NUXT_TURNSTILE_SECRET_KEY || '',
    sessionTtlSeconds: 60 * 60 * 24 * 30,
    dailyCreateLimit: 20,
    testMockWae: process.env.NUXT_TEST_MOCK_WAE === 'true',
    testMockTurnstile: process.env.NUXT_TEST_MOCK_TURNSTILE === 'true',
    dataset: 'sink',
    ...
    public: {
      ...
      slugDefaultLength: '6',
      kvBatchLimit: '50',
      turnstileSiteKey: process.env.NUXT_PUBLIC_TURNSTILE_SITE_KEY || process.env.NUXT_TURNSTILE_SITE_KEY || '',
    },
  },
  routeRules: {
    '/': {
